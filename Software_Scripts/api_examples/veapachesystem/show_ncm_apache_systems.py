""""
This sample shows Apache Systems NCM data
"""
...
# the pint package to also display some results in IP units
...
if __name__ == '__main__':
    ...
    for ap_sys in ap_systems:
        ...
        # Heating data, including NCM-only data
        print("  Heating:")
        heating = ap_sys.heating(True)
        ...
        # Cooling data, including NCM-only data
        print("  Cooling:")
        cooling = ap_sys.cooling(True)
        ...
        # Hot water data, including NCM-only data
        print("  Hot water:")
        hot_water = ap_sys.hot_water(True)
        ...
        # NCM mode data for solar heating
        print("  Solar heating NCM data:")
        pp.pprint(ap_sys.solar_water_heating_ncm())
        print("")

        # Auxiliary energy NCM-only data
        print("  Auxiliary energy:")
        aux_energy = ap_sys.auxiliary_energy(True)
        ...
        # NCM wizard data from this point
        # General NCM data
        print("  General NCM data:")
        pp.pprint(ap_sys.general_ncm())
        print("")

        # Heating NCM data
        print("  Heating NCM data:")
        pp.pprint(ap_sys.heating_ncm())
        print("")

        # Cooling NCM data
        print("  Cooling NCM data:")
        pp.pprint(ap_sys.cooling_ncm())
        print("")

        # System adjustment NCM data
        print("  System adjustment NCM data:")
        pp.pprint(ap_sys.system_adjustment_ncm())
        print("")

        # Metering provision NCM data
        print("  Metering Provision NCM data:")
        pp.pprint(ap_sys.metering_provision_ncm())
        print("")

        # Ventilation NCM data
        print("  Ventilation NCM data:")
        pp.pprint(ap_sys.ventilation_ncm())
        print("")

        # System Controls NCM data
        print("  System controls NCM data:")
        pp.pprint(ap_sys.system_controls_ncm())
        print("")

        # Bivalent Systems NCM data
        print("  Bivalent Systems NCM data:")
        pp.pprint(ap_sys.bivalent_systems_ncm())
        print("")